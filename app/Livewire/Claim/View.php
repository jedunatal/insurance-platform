            ...
            ->schema([
                Section::make('Resumo da Ocorrência')
                    ->schema([
                        ...
                        TextEntry::make('insurer_claim_number')->label('Nº Sinistro Seguradora')->placeholder('-'),
                        ...
                        TextEntry::make('location')->label('Local')->placeholder('Não informado'),
                    ])->columns(3),

                Section::make('Partes Vinculadas')
                    ->schema([
                        TextEntry::make('insured.name')->label('Segurado'),
                        TextEntry::make('policy.policy_number')->label('Apólice'),
                    ])->columns(2),
