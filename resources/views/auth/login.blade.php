...
<head>
    ...
    <title>Acesso Seguro | Salut Royale</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 rounded-3xl p-8 shadow-2xl transition-all">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Salut Royale</h1>
        ...
        <div class="text-center mt-6 text-xs text-slate-400 dark:text-slate-500">
            &copy; {{ date('Y') }} Salut Royale Corretora de Seguros. Ambiente Seguro com Proteção de Dados LGPD.
        </div>
    </div>
</body>
</html>
